...
public:
    ...
    int height = 960;
    double fov = 40;
    MyVector::Vector3f backgroundColor = MyVector::Vector3f(0.235294, 0.67451, 0.843137);
    int maxDepth = 1;
    ...
    BVHAccel *bvh;
    void buildBVH();
    MyVector::Vector3f castRay(const Ray &ray, int depth) const;
    void sampleLight(Intersection &pos, float &pdf) const;
    bool trace(const Ray &ray, const std::vector<Object*> &objects, float &tNear, uint32_t &index, Object **hitObject);
    std::tuple<MyVector::Vector3f, MyVector::Vector3f> HandleAreaLight(const AreaLight &light, const MyVector::Vector3f &hitPoint, const MyVector::Vector3f &N,
                                                   const MyVector::Vector3f &shadowPointOrig,
                                                   const std::vector<Object *> &objects, uint32_t &index,
                                                   const MyVector::Vector3f &dir, float specularExponent);
